...
<nav class="bg-white shadow-md py-6 border-b-2 fixed top-0 left-0 w-full z-10">
    ...
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-lg w-full lg:w-2/3">
        ...
        <h1 class="text-2xl font-bold text-center text-[#5277ff] mb-8">Clientes Cadastrados</h1>
            ...
            <ul class="list-none p-0">
                @if (isset($clientes) && count($clientes) > 0)
                    @foreach ($clientes as $cliente)
                        <li class="mb-6 p-6 bg-white rounded-lg border-2 border-[#5277ff] hover:shadow-xl transition client-item">
