...
<body class="bg-gray-100">
    ...
    <div class="max-w-3xl w-full px-6 py-4 bg-white rounded-lg shadow-xl">
        <h1 class="text-2xl font-bold text-center text-[#5277ff] mb-6">Cadastrar Cliente</h1>
        <form action="{{ url('/clientes/store') }}" method="post">
            ...
            <button class="mt-6 w-full py-3 px-4 bg-[#5277ff] font-bold text-white rounded hover:bg-[#3253CB] p-3">Cadastrar</button>
        </form>
    </div>
