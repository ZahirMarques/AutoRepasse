...
<body>
    <div class="bg-cover grid h-screen object-center bg-gradient-to-l from-white from-65% to-violet-700 place-items-center min-h-screen">
        <div class="grid grid-cols-2 gap-4 h-5/6 w-11/12">
            ...
            <div class="grid grid-rows-3 grid-flow-col place-items-center mt-[16vh]">
                ...
                <div class="w-9/12 h-4/6 text-2xl font-semibold leading-snug text-justify text-black-900">
                    <p>Cadastre-se agora na AutoRepasse e transforme sua concessionária com a melhor solução em gestão de vendas automotivas, garantindo eficiência, produtividade e agilidade na busca de informações.</p>
                </div>
            ...
            <div class="border-l-2 border-gray-400 grid-flow-col place-items-center">
                <div class="mt-[23%] text-center text-4xl font-bold leading-9 tracking-tight text-violet-500 pt-12">
    ...
    <!-- Paleta de cores para o css -->
    <!-- https://paletadecores.com/paleta/e7eed0/cad1c3/948e99/51425f/2e1437/ -->
</body>
