    ...
    <div class="bg-cover grid h-screen object-center bg-gradient-to-l from-white from-65% to-indigo-500 place-items-center min-h-screen">
        <div class="grid grid-cols-2 gap-4 h-5/6 w-11/12"> 
            ...
            <div class="grid grid-rows-3 grid-flow-col place-items-center mt-[16vh]">
                ...
                <div class="w-9/12 h-2/6 mb-[13vh]"><button class="shadow-lg shadow-gray-600 px-4 py-2 bg-white text-indigo-500 border-2 font-bold border-indigo-500 rounded-lg hover:bg-indigo-700 hover:text-white focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" onclick="window.location.href='/register'">Cadastre-se</button></div>
            </div>
        
            <div class="border-l-2 border-gray-400 grid-flow-col place-items-center">
                <div class="mt-[23%] text-center text-4xl font-bold leading-9 tracking-tight text-indigo-500 pt-12"><h1>Já possui uma conta?</h1></div>
                <div class="sm:mx-auto sm:w-full sm:max-w-sm border-2 border-indigo-500 rounded-lg mt-12 px-7 py-7 row-span-3 mb-30 shadow-2xl shadow-gray-400">
                    ...
                    <button class="w-full bg-indigo-500 text-white py-2 font-bold rounded hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"> Login</button>
                    </form>
