...
<div class="bg-cover grid place-items-center min-h-screen pt-24 from-white">
    ...
    <div class="max-w-3xl w-full px-6 py-4 bg-white rounded-lg shadow-xl">
        <h1 class="text-2xl font-bold text-center text-[#5277ff] mb-6">Cadastrar Venda</h1>
        <form action="{{ url('/vendas/store') }}" method="post">
            ...
            <button class="mt-6 w-full py-3 px-4 bg-[#5277ff] font-bold text-white rounded focus:outline-none hover:bg-[#3253CB]">Cadastrar Venda</button>
        </form>
    </div>
